                    ...
                    <table @if($testimonials->count()>0) id="example1" @else id="" @endif class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>          
                                ...
                                <td>{{ $testimonials_data->description }} </td>  
                                <td>
                                    @if($testimonials_data->image!='')
                                    <img src="<?php echo url('uploads/testimonials_photo/'.$testimonials_data->id); ?>/<?php echo $testimonials_data->image; ?>" style="width:100px; height:90px;">
                                    @else
